      ...
      <>
        ...
        <div className="absolute top-4 left-4 right-4 z-20 max-w-lg mx-auto">
              ...
              onClick={() => setSearchStep('search')}>
                  ...
                  <div className="flex-1 min-w-0 bg-muted/50 rounded-xl px-3 py-2.5 group-hover:bg-accent transition-colors">
                    <span className="text-[10px] uppercase tracking-wider text-muted-foreground font-medium">Till</span>
                    <div className={`text-sm ${destination ? 'text-foreground font-medium' : 'text-muted-foreground/60'}`}>
            ...
            <div className="bg-card/95 backdrop-blur-sm rounded-xl shadow-md border border-border/60 overflow-hidden">
              <div className="gap-1.5 px-2 py-1.5 flex items-center">
                ...
                className="flex-1 min-w-0 flex flex-col hover:bg-accent/40 rounded-md transition-colors">
                  ...
                  {/* Från rad */}
                  <div className="shadow flex-col rounded border-solid border border-primary gap-0 bg-gray-300 flex items-start justify-start mx-0 my-[3px] py-[5px] px-[7px] pb-0 pr-0 pt-[3px] pl-[6px]">
                    <div className="w-2 h-2 rounded-full bg-emerald-500 shrink-0" />
                    <span className="truncate text-sm px-0 text-primary bg-gray-300 mx-[12px] my-[2px]">{start || 'Min position'}</span>
                  </div>
